            ...
            <div className={styles.texts}>
                <div className={styles.section}>
                    ...
                    <p className={styles.text}>
                        ...
                        request a service or subscribe to our newsletter.
                    </p>
                    <p className={styles.text}>
                    ...
                    <p className={styles.text}>
                        When ordering the services on our site, as appropriate,
                        you may be asked to enter your: name, e-mail address or
                        discord tag. You may, however, visit our site
                        anonymously.
                    </p>
                    <p className={styles.text}>
                ...
                <div className={styles.section}>
                    ...
                    <p className={styles.text}>
                        ...
                        the safety of your personal information when you submit
                        a request, place an order or enter, submit, or access
                        your personal information.
                    </p>
                    <p className={styles.text}>
                        These security measures include: password protected
                        directories and databases to safeguard your information,
                        SSL (Secure Sockets Layered) technology to ensure that
                        your information is fully encrypted and sent across the
                        Internet securely or PCI Scanning to actively protect
                        our servers from hackers and other vulnerabilities.
                    </p>
                    <p className={styles.text}>
                    ...
                    <p className={styles.text}>
                        ...
                        cards, social security numbers, financials, etc.) will
                ...
                <div className={styles.section}>
                    ...
                    <p className={styles.text}>
                        ...
                        in your shopping cart, understand and save your
                        preferences for future visits, keep track of
                        ...
                        contract with third-party service providers to assist us
                        in better understanding our site visitors. These service
                        providers are not permitted to use the information
                        collected on our behalf except to help us conduct and
                        improve our business.
                    </p>
                    <p className={styles.text}>
                        If you prefer, you can choose to have your computer warn
                        you each time a cookie is being sent, or you can choose
                        to turn off all cookies via your browser settings. Like
                        most websites, if you turn your cookies off, some of our
                        services may not function properly. However, you can
                        still place orders by contacting customer service.
                    </p>
                    <p className={styles.text}>
                        We also use web beacons in conjunction with cookies to
                        help us gather additional information about your visit
                        to our website.
                    </p>
                </div>

                <div className={styles.section}>
                    <h2 className={styles.sectionTitle}>The Cookies We Set:</h2>
                    <p className={styles.text}>
                        Email newsletters related cookies. This site offers
                        newsletter or email subscription services and cookies
                        may be used to remember if you are already registered
                        and whether to show certain notifications which might
                    ...
                    <p className={styles.text}>
                        ...
                        essential to ensure that your order is remembered
                        between pages so that we can process it properly.
                    </p>
                    <p className={styles.text}>
                        Forms related cookies. When you submit data to through a
                        form such as those found on contact pages or comment
                        forms cookies may be set to remember your user details
                        for future correspondence.
                    </p>
                    <p className={styles.text}>
                        Site preferences cookies. In order to provide you with a
                        great experience on this site we provide the
                        functionality to set your preferences for how this site
                        runs when you use it. In order to remember your
                        preferences we need to set cookies so that this
                        information can be called whenever you interact with a
                ...
                <div className={styles.section}>
                    ...
                    <p className={styles.text}>
                        Google Analytics which is one of the most widespread and
                        trusted analytics solution on the web for helping us to
                        understand how you use the site and ways that we can
                        ...
                        content. Provided by Google Inc. (United States) Privacy
                        Shield participant.
                        https://policies.google.com/technologies/ads.
                    </p>
                    <p className={styles.text}>
                        Bing Ads analytics system to learn more about customers
                        that came from the Bing search. Provided by Microsoft
                        Corporation (United States) Privacy Shield participant.
                ...
                <div className={styles.section}>
                    ...
                    <p className={styles.text}>
                        Access your data: You may be able to receive a report
                        about the data we store about you.
                    </p>
                    <p className={styles.text}>
                        Erasure: You may have a right to request the deletion of
                        some your data.
                    </p>
                    <p className={styles.text}>
                    ...
                    <p className={styles.text}>
                        ...
                        longer be processed in certain cases, for instance, when
                        you exercise your right to object as described above.
                        When objecting, you will be given an option to restrict
                        processing.
                    </p>
                    <p className={styles.text}>
                        Portability: Data portability is the ability to move
                        data from one company to another (for instance, when you
                        transfer your mobile phone service to another carrier).
                        While this right is not very applicable to our current
                        business, we will provide you with an electronic file
                        with your most basic account information, should you
                        request it.
                    </p>
                    <p className={styles.text}>
                        If you wish to perform any of the actions listed, please
                ...
                <div className={styles.section}>
                    ...
                    <p className={styles.text}>
                        ...
                        compliant with the General Data Protection Regulation by
                        protecting the personal data and privacy of EU citizens
                ...
                <div className={styles.section}>
                    <h2 className={styles.sectionTitle}>CAN-SPAM Compliance</h2>
                    <p className={styles.text}>
                        We have taken the necessary steps to ensure that we are
                        compliant with the CAN-SPAM Act of 2003 by never sending
                ...
                <div className={styles.section}>
                    ...
                    <ul className={styles.list}>
                        ...
                        <li className={styles.listItem}>Privacy Alliance</li>
                        <li className={styles.listItem}>
                ...
                <div className={styles.section}>
                    ...
                    <p className={styles.text}>
                        ...
                        Policy modification date below. Policy changes will
                        apply only to information collected after the date of
                        the change.
                    </p>
                </div>
