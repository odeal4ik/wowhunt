                ...
                <div className={styles.texts}>
                    ...
                    <div className={styles.section}>
                        ...
                        <p className={styles.text}>
                            ...
                            Website. By using this Website and by agreeing to
                            this Agreement you warrant and represent that you
                    ...
                    <div className={styles.section}>
                        ...
                        <p className={styles.text}>
                            ...
                            accordance with the fees, charges, and billing terms
                            in effect at the time a fee or charge is due and
                            payable. If, in our judgment, your purchase
                            constitutes a high-risk transaction, we will require
                            you to provide us with a copy of your valid
                            government-issued photo identification, proof of
                            address, and possibly a copy of a recent bank
                            statement for the credit or debit card used for the
                            purchase. We reserve the right to change services
                            and service pricing at any time. We also reserve the
                            right to refuse any order you place with us. We may,
                            in our sole discretion, limit or cancel quantities
                            purchased per person, per household or per order.
                            These restrictions may include orders placed by or
                            under the same customer account, the same PayPal
                    ...
                    <div className={styles.section}>
                        ...
                        <p className={styles.text}>
                            ...
                            specified time terms, you have the right to request
                            a refund, or we may refund the money in our own
                            discretion. You have the right to cancel your order
                            and ask for a full refund at any time before the
                            start of the service. You have the right to cancel
                            your order after the start of the service and ask
                            for a partial refund. In this case, the amount of
                            the refund will be proportional to the volume of the
                            unfinished services.
                        </p>
                    </div>
                    <div className={styles.section}>
                        ...
                        <p className={styles.text}>
                            ...
                            promotions and offers. We reserve the right to
                            correct any errors, inaccuracies or omissions, and
                            to change or update information or cancel orders if
                            any information on the Website or on any related
                            Service is inaccurate at any time without prior
                    ...
                    <div className={styles.section}>
                        ...
                        <p className={styles.text}>
                            ...
                            communicating with us electronically. You are
                            consenting to receive electronic communications from
                            us. We might be using such methods as Live chat,
                            Discord or Email to communicate with you. You are
                            agreeing that any information provided to us is
                            truthful and factual without any intentional
                    ...
                    <div className={styles.section}>
                        ...
                        <p className={styles.text}>
                            ...
                            intellectual property owned by wowhunt or
                            third-parties, and all rights, titles, and interests
                            in and to such property will remain (as between the
                            parties) solely with wowhunt and/or other respective
                            companies. Your use of our Website and Services
                            grants you no right or license to reproduce or
                            otherwise use any wowhunt or third-party trademarks.
                        </p>
                    </div>
                    <div className={styles.section}>
                        <h2 className={styles.sectionTitle}>
                    ...
                    <div className={styles.section}>
                        ...
                        <p className={styles.text}>
                            ...
                            agents harmless from and against any liabilities,
                            losses, damages or costs, including reasonable
                            attorneys’ fees, incurred in connection with or
                            arising from any third-party allegations, claims,
                            actions, disputes, or demands asserted against any
                            of them as a result of or relating to your use of
                            the Website or Services or any willful misconduct on
                            your part.
                        </p>
                    </div>
                    <div className={styles.section}>
                    ...
                    <div className={styles.section}>
                        ...
                        <p className={styles.text}>
                            ...
                            and agree to all its terms and conditions. By using
                            the Website or its Services you agree to be bound by
