  ...
  return (
    <section className={styles.hero}>
      ...
      <div className={styles.heading}>
        ...
        <p className={styles.heroDescription}>Avoid wasting time with pugs</p>
      </div>
      <div className={styles.advantages}>
        {advantages.map((advantage) => (
          <div className={styles.advantagesItem} key={advantage.title}>
            <div className={styles.advantagesIcon}>
              <img src={advantage.icon} alt={advantage.title} loading="lazy" />
            </div>
            <div className={styles.advantagesContent}>
              <div className={styles.advantagesTitle}>{advantage.title}</div>
              <div
